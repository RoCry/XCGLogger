...
open class XCGBaseLogDestination: XCGLogDestinationProtocol, CustomDebugStringConvertible {
    ...
    public func processLogDetails(_ logDetails: XCGLogDetails) {
        ...
        if showFileName {
            extendedDetails += "[" + (logDetails.fileName as NSString).lastPathComponent + (showLineNumber ? ":" + String(describing: logDetails.lineNumber) : "") + "] "
        }
        else if showLineNumber {
            extendedDetails += "[" + String(describing: logDetails.lineNumber) + "] "
        }
...
public class XCGLogger: CustomDebugStringConvertible {
    ...
    public class func logln(_ closure: @autoclosure () -> Any?, logLevel: LogLevel = .debug, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
    ...
    public func logln(_ closure: @autoclosure () -> Any?, logLevel: LogLevel = .debug, functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
